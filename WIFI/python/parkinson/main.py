...
motor_button_1.grid(row=5, column=0, columnspan=2, pady=(20, 0))
...
motor_button_2.grid(row=6, column=0, columnspan=2, pady=(20, 0))
motor_button_3 = tk.Button(
    root,
    text="Activate motor 3",
    command=lambda: motor_on(2),
    bg="red",
    fg="white",
)
motor_button_3.grid(row=7, column=0, columnspan=2, pady=(20, 0))
motor_button_4 = tk.Button(
    root,
    text="Activate motor 4",
    command=lambda: motor_on(3),
    bg="red",
    fg="white",
)
motor_button_4.grid(row=8, column=0, columnspan=2, pady=(20, 0))
...
all_motors_button.grid(row=9, column=0, columnspan=2, pady=(20, 0))
...
record_button.grid(row=5, column=1, columnspan=2, pady=(20, 0))
...
sync_button.grid(row=6, column=1, columnspan=2, pady=(20, 0))

# Slider para acc_y_threshold
acc_y_slider_label = tk.Label(root, text="acc_y th:")
acc_y_slider_label.grid(row=7, column=1, columnspan=4, pady=(20, 0))
...
acc_y_slider.grid(row=8, column=1, columnspan=2)
